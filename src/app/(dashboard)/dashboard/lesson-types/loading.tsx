export default function LessonTypesLoading() {
  return (
    <div className="animate-pulse space-y-6">
      ...
      <div className="overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700">
        <div className="bg-gray-50 dark:bg-gray-800 px-4 py-3 flex gap-4">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="h-4 w-16 rounded bg-gray-200 dark:bg-gray-700" />
          ))}
        </div>
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="border-t border-gray-200 dark:border-gray-700 px-4 py-3 flex gap-4 items-center">
            <div className="h-4 w-32 rounded bg-gray-200 dark:bg-gray-700" />
