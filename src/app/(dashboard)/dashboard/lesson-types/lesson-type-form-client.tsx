...
const initialState: LessonTypeActionState = { success: false };

export function AddLessonTypeForm({ primaryColor }: Props) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded-xl bg-white dark:bg-gray-800 shadow-xl max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 px-6 py-4">
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Add Lesson Type</h2>
            ...
            <form action={formAction} className="space-y-4 p-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input type="number" name="duration_minutes" required min={15} max={240} defaultValue={60}
                    className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-2 text-sm text-gray-900 dark:text-white" />
                </div>
                <div>
              ...
              <div className="flex items-center gap-2">
                <input type="checkbox" name="is_public" value="true" defaultChecked id="lt-is-public"
                  className="rounded border-gray-300 dark:border-gray-600" />
                <label htmlFor="lt-is-public" className="text-sm text-gray-700 dark:text-gray-300">Show on public website</label>
              </div>
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button type="submit" disabled={isPending}
                  ...
                  style={{ backgroundColor: primaryColor }}>
                  {isPending ? 'Adding…' : 'Add Lesson Type'}
                </button>
              </div>
            </form>
          </div>
